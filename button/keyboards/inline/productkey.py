...
#         [
#             InlineKeyboardButton(text='kurslar', callback_data="curses"),
#             InlineKeyboardButton(text='kitoblar', callback_data="books"),
#         ],


#         [
#             InlineKeyboardButton(text='Kitob', url="https://youtu.be/yhR-pUUliLw?si=yskh-udSCmO8IK3c" ),
#         ],
