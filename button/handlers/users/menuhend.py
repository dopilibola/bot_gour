...
# from keyboards.inline.productkey import categoryMenu, courseeMenu
# from loader import dp

# @dp.message_handler(text='Maxsulotlar')
# async def select_category(message: Message):
#     await message.answer(f"Mavzuni tanla  ", reply_markup=categoryMenu )

# @dp.callback_query_handler(text='kurslar')
# async def buy_coursee(call: CallbackQuery):
#     await call.message.answer("kurni tanla", reply_markup=courseeMenu)
...
from keyboards.inline.productkey import categoryMenu, coursesMenu, booksMenu, telegram_keyboard, algoritm_keyboard
from loader import dp
